...
def show_timeout_help(color='white', symbol_color='white'):
    ...
    dialog(f'                       sudo wihunter {o}--timeout 20{b} wlan0', color=color, symbol_color=symbol_color)
    dialog(f'                                     -------------', color=color)
...
def show_help(color='white', symbol_color='white'):
    ...
    dialog(f'', color=color)
    dialog(f'                  Ex.: sudo wihunter {o}-h{b}', color=color, symbol_color=symbol_color)
    dialog(f'                       sudo wihunter {o}--help{b}', color=color, symbol_color=symbol_color)
    dialog(f'                                     ------', color=color)
